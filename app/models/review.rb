...
class Review < ApplicationRecord
  ...
  validates_numericality_of :genuine_idea__research, less_than_or_equal_to:  50                      
  validates_numericality_of :genuine_idea__proof, less_than_or_equal_to: 50                           
  validates_numericality_of :genuine_idea__processes, less_than_or_equal_to: 50                      
  validates_numericality_of :innovativeness__target_user_expectations, less_than_or_equal_to: 30      
  validates_numericality_of :innovavativeness__genuine, less_than_or_equal_to: 30                     
  validates_numericality_of :innovativeness__similarity_to_other_projects, less_than_or_equal_to: 30  
  validates_numericality_of :innovativeness__benefits_to_users, less_than_or_equal_to: 30             
  validates_numericality_of :innovativeness__research, less_than_or_equal_to: 30                      
  validates_numericality_of :idea__short_history, less_than_or_equal_to: 80                           
  validates_numericality_of :idea__tecniques_methods, less_than_or_equal_to: 80                      
  validates_numericality_of :idea__verification, less_than_or_equal_to: 80                            
  validates_numericality_of :idea__cost_cutting_techniques, less_than_or_equal_to: 80                 
  validates_numericality_of :idea__new_tech_cost_cutting_advantages, less_than_or_equal_to: 80       
  validates_numericality_of :industry__market_potential, less_than_or_equal_to: 40                    
  validates_numericality_of :industry__physibility, less_than_or_equal_to: 80                         
  validates_numericality_of :industry__sales_potential, less_than_or_equal_to: 40                     
  validates_numericality_of :industry__added_value, less_than_or_equal_to: 40                         
